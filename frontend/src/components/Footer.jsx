    ...
    <>
      <div className="padreFooter">
        <div className="logoFooter">
          <img src="https://res.cloudinary.com/dvoh9w1ro/image/upload/v1700508270/logo_mnofpi.png" />
        </div>
        ...
        <div className="infoContacto">
          ...
          <p>
            ...
            <span className="informacionContacto">
              {" "}
              rodarbarcelona@rodaryrodar.com{" "}
            </span>
          </p>
          <p>
            {" "}
            ...
            <span className="informacionContacto">
              {" "}
              Carrer de L'Església, 4-6 <br></br>Barcelona 08024{" "}
            </span>
          </p>
        </div>
